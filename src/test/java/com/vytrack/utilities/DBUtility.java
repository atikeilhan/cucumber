...
public class DBUtility {
    ...
    public static Connection getConnection() throws SQLException {
        return DriverManager.getConnection(ConfigurationReader.get("oracledb.url"),
        ...
        try {
            switch (dbType) {
                case ORACLE:
                    ...
                    break;
                case MYSQL:
                    connection = DriverManager.getConnection(ConfigurationReader.get("mysqldb.url"),
                            ConfigurationReader.get("mysqldb.user"),
                            ConfigurationReader.get("mysqldb.password"));
                    break;
                default:
                    connection = null;
